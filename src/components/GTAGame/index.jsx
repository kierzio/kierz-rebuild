        ...
        {isGameReady ? (
          <>
            <Canvas 
              ...
              gl={{ antialias: true }}
              onCreated={(state) => {
                state.gl.setClearColor('#000000'); // Set clear color to black
              }}
            >
              <Suspense fallback={
                <Html center>
          ...
          <div className="absolute inset-0 bg-cyber-dark flex flex-col items-center justify-center z-30">
            ...
            <div className="w-64 h-2 bg-cyber-light rounded-full overflow-hidden mb-8">
              <div 
                ...
                style={{ width: '75%', animationDuration: '1s', animationName: 'pulse', animationIterationCount: 'infinite' }}
              ></div>
            </div>
            <p className="text-neon-purple font-orbitron text-lg">
...
const Floor = () => {
  ...
  return (
    <mesh ref={ref} receiveShadow>
      ...
      <meshStandardMaterial color="#111111" opacity={0.8} transparent />
    </mesh>
  );
};
