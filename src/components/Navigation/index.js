...
const Navigation = () => {
  ...
  return (
    ...
    >
          ...
          {["intro", "about", "projects", "contact"].map((section) => {
            ...
            return (
              <button
                ...
                className={`relative text-sm uppercase tracking-wider font-orbitron py-1 transition-all duration-300 ${
              ...
              >
                ...
                {isActive && (
                  <span className="absolute -bottom-1 left-0 w-full h-0.5 bg-neon-blue animate-fadeIn"></span>
                )}
              </button>
            );
          })}
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden fixed inset-0 top-16 bg-cyber-dark/95 backdrop-blur-md py-6 px-4 animate-fadeIn z-40">
          <div className="flex flex-col space-y-6 items-center pt-6">
            {["intro", "about", "projects", "contact"].map((section) => {
              ...
              return (
                <button
                  ...
                  className={`text-center text-lg uppercase tracking-wider font-orbitron py-3 px-8 w-full max-w-xs transition-all duration-300 border-b border-neon-blue/10 ${
                    isActive 
            ...
            <div className="pt-6 flex space-x-6">
              <a href="https://github.com/kierzio" target="_blank" rel="noopener noreferrer" className="text-white hover:text-neon-blue transition-all duration-300">
              ...
              <a href="https://twitter.com/kierz_io" target="_blank" rel="noopener noreferrer" className="text-white hover:text-neon-purple transition-all duration-300">
              ...
              <a href="https://linkedin.com/in/kierzio" target="_blank" rel="noopener noreferrer" className="text-white hover:text-neon-pink transition-all duration-300">
